...
const ICONS = {
  ...
  search:
    '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><circle cx="10.75" cy="10.75" r="6.75"/><path d="m16 16l4 4"/></g>',
  close: '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" d="m6 6l12 12M18 6L6 18"/>',
  arrowUp:
  ...
  imageSparkle:
    '<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><rect width="16" height="15" x="3" y="6" rx="2"/><circle cx="8.25" cy="11.25" r="1.25"/><path d="m4.5 18l3.75-3.75a1.5 1.5 0 0 1 2.121 0L14 17.879l1.129-1.129a1.5 1.5 0 0 1 2.121 0L19 18.5M19.5 2v4M21.5 4h-4"/></g>',
  warning: '<path fill="currentColor" d="M1 21L12 2l11 19zm10-3h2v-2h-2zm0-4h2v-4h-2z"/>',
  speed:
